...
with(Power.Consumption.Subset, plot(DateTime, Global_active_power, ylab = "Global Active Power", xlab='', type='l'))

#   Plot data for "Voltage" in the first row and second column
with(Power.Consumption.Subset, plot(DateTime, Voltage, ylab = "Voltage", xlab='datetime', type='l'))

#   Plot data for "Sub_metering_1" in the second row and first column
with(Power.Consumption.Subset, plot(DateTime, Sub_metering_1, ylab = "Energy sub metering", xlab='', type='l'))
...
with(Power.Consumption.Subset, plot(DateTime, Global_reactive_power, ylab = "Global_reactive_power", xlab='datetime', type='l'))
